...
class DataCleaningDialog(_NoEnterAutoAccept, QtWidgets.QDialog):
    def __init__(self, main_window) -> None:
        ...
        logic_hint = QtWidgets.QLabel(
            "Ein Bild gilt als Ausreißer, wenn AN JEDEM markierten Referenzpunkt (bzw. dessen "
            "gemitteltem Bereich) die Temperaturänderung zum vorherigen Bild den Schwellenwert "
            "überschreitet."
        )
        ...
        self.btn_apply = buttons.addButton("Anwenden", QtWidgets.QDialogButtonBox.ButtonRole.ApplyRole)
    ...
    def refresh_candidates(self) -> None:
        ...
        angehakt ist der jeweilige Standardzustand. Erst _on_apply_clicked
        uebernimmt die tatsaechlich angehakten Checkboxen als neue
        Ausschluss-Menge."""
